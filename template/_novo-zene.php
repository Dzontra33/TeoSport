 <?php
    ...
    $product_shuffle = $product->newProductsForWoman();
 ...
 <section id="new-product-page">
     ...
     <div class="card text-center p-5 border-0">
         <img src="./assets/img/cover_new2.jpg" class=" img-fluid" alt="...">
     </div>
     <div class="container">
         <h1 class="font-signika text-uppercase text-center">Nova kolekcija za <a class="text-decoration-none color-primay" href="muskarci.php">žene</a></h3>
             <hr>
